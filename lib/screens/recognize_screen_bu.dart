...
//       final userId = await _apiService.recognize(embedding);
//
//       if (userId != null) {
//         final success = await _apiService.markAttendance(userId);
//         if (success) {
...
//         } else {
//           ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Failed to mark attendance')));
//         }
//       } else {
